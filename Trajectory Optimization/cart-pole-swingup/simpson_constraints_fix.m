function [c,ceq] = simpson_constraints_fix(x, m1, m2, l, times, target)
    c = [];
    ...
    for i = 1:len-1
       ...
       half_control = (u(i)+u(i+1))/2;
       half_dynamics = cartpole_dynamics(half_state, half_control, m1, m2, l);
       ceq = [ceq, next_state - (current_state + (dt/6)*(current_dynamics+4*half_dynamics+next_dynamics))];           
    end
end
